      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-center mb-2">
            <h1 class="mb-0 text-dark text-uppercase font-weight-bold mt-5">Edit DATA</h1>
          </div>
          <div class="d-sm-flex align-items-center justify-content-center mb-4">
            <h3 class="mb-0 text-dark text-dark font-weight-light mb-4">Masukkan nama provinsi, jumlah terkonfirmasi, tenaga medis dan Obat baru</h3>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-md-4">
              <?php foreach($data as $u){ ?>
                <form action="<?php echo base_url(). 'admin/clustering/update'; ?>" method="post">
                  <div class="form-group">
                    <label for="provinsi">Nama Provinsi</label>
                    <input type="hidden" name="no" value="<?php echo $u->no ?>">
                    <input type="text" class="form-control" name="provinsi" value="<?php echo $u->provinsi ?>" placeholder="Masukkan nama provinsi">
                  </div>
                  <div class="form-group">
                    <label for="terkonfirmasi">Jumlah Terkonfirmasi</label>
                    <input type="text" class="form-control" name="terkonfirmasi" value="<?php echo $u->terkonfirmasi ?>" placeholder="Masukkan jumlah terkonfirmasi">
                  </div>
                  <div class="form-group">
                    <label for="tenaga_medis">Jumlah Tenaga Medis</label>
                    <input type="text" class="form-control" name="tenaga_medis" value="<?php echo $u->tenaga_medis ?>" placeholder="Masukkan jumlah tenaga medis">
                  </div>
                  <div class="form-group">
                    <label for="Obat">Jumlah Obat</label>
                    <input type="text" class="form-control" name="Obat" value="<?php echo $u->Obat ?>" placeholder="Masukkan jumlah Obat">
                  </div>
